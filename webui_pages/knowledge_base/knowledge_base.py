...
def knowledge_base_page(api: ApiRequest, is_lite: bool = None):
    ...
    if selected_kb == "新建知识库":
        ...
        if not len(doc_details):
            ...
            print(doc_details)
            # if doc_details["in_folder"] == True:
            #     doc_details["in_folder"] = "✓"
            # else:
            #     doc_details["in_folder"] = "x"
            # if doc_details["in_db"] == True:
            #     doc_details["in_db"] = "✓"
            # else:
            #     doc_details["in_db"] = "x"
            doc_details["in_folder"] = doc_details["in_folder"].replace(True, "✓")
            doc_details["in_folder"] = doc_details["in_folder"].replace(False, "×")
            doc_details["in_db"] = doc_details["in_db"].replace(True, "✓")
            doc_details["in_db"] = doc_details["in_db"].replace(False, "×")
            gb = config_aggrid(
                doc_details,
                {
                    ("No", "序号"): {},
